...
class OthelloNNet():
    def __init__(self, game, args):
        ...
        s_fc1 = Dropout(args.dropout)(Activation('relu')(BatchNormalization(axis=1)(Dense(args.fully_connected_layer_width, use_bias=False)(h_conv4_flat))))  # batch_size x 1024
